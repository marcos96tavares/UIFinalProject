...
import { FaExclamationTriangle, FaCheckCircle, FaUser, FaEnvelope, FaLock, FaBirthdayCake } from 'react-icons/fa';
// Import the register function instead of using axios directly
...
const Register = () => {
  ...
  // Handle age input to only allow integers
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use the register function instead of direct axios call
      const registrationData = {
        userId: {
          firstNameDto: formData.firstName,
          lastNameDto: formData.lastName,
          emailDto: formData.email,
          ageDto: parseInt(formData.age), // Convert age to integer
      ...
      // Call the register function which handles user ID extraction and storage
                            ...
                            <>
                              ...
                              <span className="input-group-text">
                                <FaBirthdayCake className="text-primary" />
                                  ...
                                  <div className="form-text">You must be at least 16 years old</div>
                                </div>
